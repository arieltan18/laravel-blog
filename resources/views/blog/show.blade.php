...
@section('header')
    <!-- Header -->
    <header class="header text-white h-fullscreen pb-80" style="background-image: url('{{secure_asset('/storage/'.$post->image)}}')" data-overlay="9">
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <script>
                            ...
                            (function() { // DON'T EDIT BELOW THIS LINE
                                ...
                                s.src = 'https://saas-blog-lwyezxrihf.disqus.com/embed.js';
